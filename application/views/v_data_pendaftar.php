			...
			<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
				...
				<li class="nav-item dropdown">
					<a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">
						...
						<div class="text-white dropdown-item display-4"><a class="drop-btn" href="<?php echo base_url('admin/data_pendaftar'); ?>">Data Pendaftaran</a>
...
<section class="section-table cid-rGakfBqhSo" id="table1-9">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Pendaftar Beasiswa</h2>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
			...
			<tr class='clickable-row' >
				...
				<td><a href="<?php echo base_url("assets/upload/$d->dokumen.docx")?>" download>Lihat Dokumen</a></td>
				<?php if ($d->status == "Belum Diterima"){?>
				<td><a href="<?php echo base_url("admin/accept/$d->id_pendaftaran"); ?>" onclick="return confirm('Menambahkan <?php echo $d->nama ?> dengan NIM <?php echo $d->nim ?> sebagai penerima beasiswa <?php echo $d->nama_bea ?> ?')" >Terima Beasiswa</a></td>
				<?php }else{ ?>
