			...
			<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
				...
				<li class="nav-item dropdown">
					<a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">
						...
						<div class="text-white dropdown-item display-4"><a class="drop-btn" href="<?php echo base_url('admin/histori'); ?>">Histori Beasiswa</a>
...
<section class="section-table cid-rGakfBqhSo" id="table1-9">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">RIWAYAT BEASISWA</h2>
          ...
          <table class="table isSearch" cellspacing="0">
            <thead>
              <tr class="table-heads ">
				 ...
				 <th class="head-item mbr-fonts-style display-7">Nama Beasiswa</th>
				  <th class="head-item mbr-fonts-style display-7">Jenis Beasiswa</th>
				  <th class="head-item mbr-fonts-style display-7">Fakultas</th>
				  <th class="head-item mbr-fonts-style display-7">Jangka Waktu</th>
			  </tr>
