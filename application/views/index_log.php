...
<head>
  ...
  <title>BEBE</title>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/add/tambahan.css">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item dropdown">
					<a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">
						<span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span><option>Opsi</option></a><div class="dropdown-menu">
    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <p class="mbr-text pb-3 mbr-fonts-style display-5">Cari beragam Informasi Beasiswa<br>untuk mahasiswa aktif<br>Beasiswa Penuh ataupun parsial</p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-secondary display-4">Cari Beasiswa Kamu</a></div>
            </div>
        </div>
    </div>
...
<section class="timeline2 cid-rGa8zi12Wl" id="timeline2-4">
    ...
    <div class="container align-center">
        <h2 class="mbr-section-title pb-3 mbr-fonts-style display-2">
            Langkah Pendaftaran Beasiswa</h2>
        ...
        <div class="container timelines-container" mbri-timelines="">
                ...
                <div class="col-xs-12 col-md-6 align-left">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">
                            Cari Beasiswa yang Sesuai</h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">Mahasiswa mencari beasiswa yang telah tersedia sesuai dengan keinginan dan kemampuan masing masing mahasiswa.</p>
                     </div>
                </div>
            </div>
            <!--2-->
            <div class="row timeline-element  separline">
                ...
                <div class="col-xs-12 col-md-6 align-left ">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">Mendaftar Beasiswa</h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">
                            Mendaftarkan diri mahasiswa yang sudah punya pilihan beasiswa. pendaftaran dapat secara offline dengan mendownload formulir atau mengisi form secara online</p>
                    </div>
                </div>
            </div>
            <!--3-->
            <div class="row timeline-element reverse separline">
                ...
                <div class="col-xs-12 col-md-6 align-left">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">Pengumpulan Berkas</h4>      
                        <p class="mbr-timeline-text mbr-fonts-style display-7">Mahasiswa melakukan pengumpulan berkas sesuai permintaan dari penyelenggara Beasiswa</p>
                    </div>
                </div>
            </div>
            <!--4-->
            <div class="row timeline-element  separline">
                ...
                <div class="col-xs-12 col-md-6 align-left ">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">
                            Screening dan Ujian</h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">
                            Beberapa jenis Beasiswa mahasiswa dimintai Screening sebagai tahap seleksi selanjutnya. Selain itu, penyelenggara Beasiswa juga tidak menutup kemungkinan untuk melakukan pengujian terhadap mahasiswa</p>
                    </div>
                </div>
            </div>
            <!--5-->
                ...
                <div class="col-xs-12 col-md-6 align-left">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5"><p>
                            Pengumuman</p></h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">
                            Pengumuman Mahasiswa yang lolos Beasiswa dapat dilihat pada website ini.</p>
                    </div>
                </div>
            </div>
...
<section class="section-table cid-rGakfBqhSo" id="table1-9">
  ...
  <div class="container container-table">
      <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">Daftar Beasiswa yang Tersedia</h2>
      ...
      <div class="table-wrapper">
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            <thead>
			<label>Kategori :
				<select onchange="this.options[this.selectedIndex].value && (window.location = '<?php echo base_url('user/cat/'); ?>'+this.options[this.selectedIndex].value);">
              ...
              <th class="head-item mbr-fonts-style display-7">Nama Beasiswa</th><th class="head-item mbr-fonts-style display-7">Jenis Beasiswa</th><th class="head-item mbr-fonts-style display-7">
                      Fakultas</th><th class="head-item mbr-fonts-style display-7">
                      Jangka Waktu</th></tr>
            </thead>

            <tbody>
			<?php foreach ($dt as $d): ?>
			<tr class='clickable-row'  data-href='<?php echo base_url("user/daftar/$d->id"); ?>' >
